...
export default function TabLayout() {
  ...
  const { recognized, startRecognizing, started, isListening, results } = useAppContext()
  ...
  return (
    <View style={styles.container}>
      ...
      {!isCamaraOpen && <TouchableOpacity style={[styles.buttonSpeech, { borderWidth: 5, borderColor: isListening ? 'green' : 'transparent' }]} onPress={startRecognizing} >
